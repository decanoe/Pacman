...
import model.agent.behavior.pathfinding.cell_weight.EntityFleeingWeight;
import model.agent.behavior.pathfinding.cell_weight.EntityTargetWeight;
import model.agent.behavior.pathfinding.destination.EntityDestination;
import model.agent.behavior.pathfinding.destination.EntityFleeingDestination;
import model.agent.behavior.pathfinding.direction.RandomDirectionOrder;
import model.agent.behavior.pathfinding.spread.AvoidEntity;
import model.agent.behavior.pathfinding.spread.MoveCheck;
import model.maze.Maze.EntityType;

public class BehaviorFactory {
    public enum BehaviorType {
        Stop, Random, Keyboard, Dual_Default, Dual_Scared, Dual_Distance, Pathfinding
    }
    ...
    public static Behavior create_behavior(BehaviorType type) {
        switch (type) {
            ...
            case Keyboard: return new KeyboardBehavior();
